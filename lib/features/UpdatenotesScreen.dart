...
class UpdateNotesScreen extends StatefulWidget {
  ...
  const UpdateNotesScreen(
      {super.key, required this.token, required this.selected});

  @override
  State<UpdateNotesScreen> createState() => UpdateNoteScreenState();
}

class UpdateNoteScreenState extends State<UpdateNotesScreen> {
  ...
  void initState() {
    ...
    title.text = widget.selected.title.toString();
    description.text = widget.selected.description.toString();
  }
  ...
  Future<void> updatenote() async {
    ...
    var response = await dio.request(
      'http://192.168.1.7:4000/api/note/' + widget.selected.sId.toString(),
      options: Options(
        method: 'PUT',
        headers: headers,
      ),
